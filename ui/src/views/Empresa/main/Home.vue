    ...
    <div class="card-header">
      <div class=" d-flex align-items-center">
        ...
        <div class="btn-group" role="group" aria-label="Basic example">
          <RouterLink :to="{ name: 'empresa-create' }" type="button" class="btn btn-primary" v-if="!queryset.length">Nuevo <i
              class="bi bi-plus-square"></i></RouterLink>
          <RouterLink :to="{ name: 'empresa-edit' }" type="button" class="btn btn-warning" v-if="queryset.length">Editar <i
              class="bi bi-pencil-square" ></i></RouterLink>
          <RouterLink :to="{ name: 'empresa-delete' }" type="button" class="btn btn-danger" v-if="queryset.length">Eliminar <i
              class="bi bi-trash"></i></RouterLink>
        </div>
      </div>
    </div>
    <div class="card-body">
