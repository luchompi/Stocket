  ...
  <form @submit.prevent="confirmStore" v-if="!loading">
    <div class="input-group mb-3">
      ...
      <input
          type="text"
          class="form-control"
          placeholder="Indique el NIT de la empresa"
          aria-describedby="inputNIT"
          v-model="NIT"
          :required="!props.empresa"
          minlength="5"
      />
    </div>
    <div class="input-group mb-3">
      ...
      <input
          type="text"
          class="form-control"
          placeholder="Ingrese razón social de la entidad"
    ...
    <div class="input-group mb-3">
      ...
      <input
          type="email"
          class="form-control"
          placeholder="Ingrese correo electronico de la empresa"
