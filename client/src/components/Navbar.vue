      ...
      <ul class="nav me-auto">
        ...
        <li class="nav-item dropdown">
          ...
          <ul class="dropdown-menu">
            ...
            <li>
              <RouterLink :to="{ name: 'DepartamentosList' }" class="dropdown-item">Dependencias <i
                  class="bi bi-diagram-3-fill"></i></RouterLink>
            </li>
            <li>
              <hr class="dropdown-divider"/>
            </li>
            <li>
              <RouterLink :to="{name:'sedeDependencia'}" class="dropdown-item">Incluir sedes en dependencias <i
                  class="bi bi-node-plus"></i></RouterLink>
            </li>
          </ul>
        </li>
      ...
      <RouterLink :to="{ name: 'home' }"
        ...
        <div :style="{
          ...
          <div v-if="sesion.isAuth">
            <h3>Stocket - {{
                sesion.userData.groups?.includes('Administrador' || 'Encargado') ?
                    sesion.userData.groups[0] : (sesion.userData.is_superuser ? 'SuperUsuario' : 'Invitado')
              }}</h3>
          </div>
          <div v-else>
            <h3>Stocket</h3>
